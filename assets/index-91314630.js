 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ph=xh;function Na(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:fs,automaticDataCollectionEnabled:!1},e),s=i.name;if(typeof s!="string"||!s)throw Ke.create("bad-app-name",{appName:String(s)});if(n||(n=Ml()),!n)throw Ke.create("no-options");const r=ei.get(s);if(r){if(cs(n,r.options)&&cs(i,r.config))return r;throw Ke.create("duplicate-app",{appName:s})}const o=new Gl(s);for(const u of ps.values())o.addComponent(u);const a=new Fh(n,i,o);return ei.set(s,a),a}function Vh(t=fs){const e=ei.get(t);if(!e&&t===fs)return Na();if(!e)throw Ke.create("no-app",{appName:t});return e}function Tt(t,e,n){var i;let s=(i=Mh[t])!==null&&i!==void 0?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${s}" with version "${e}":`];r&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ct.warn(a.join(" "));return}ti(new tn(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kh(t){ti(new tn("platform-logger",e=>new rh(e),"PRIVATE")),ti(new tn("heartbeat",e=>new Wh(e),"PRIVATE")),Tt(ds,To,t),Tt(ds,To,"esm2017"),Tt("fire-js","")}Kh("");var zh="firebase",Qh="9.17.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function S(t="Unexpected state"){const e=`FIRESTORE (${Vt}) INTERNAL ASSERTION FAILED: `+t;throw Ue(e),new Error(e)}function P(t,e){t||S()}function D(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(e,n="asc"){this.field=e,this.dir=n}}function Cf(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt{constructor(e,n=null,i=[],s=[],r=null,o="F",a=null,u=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=i,this.filters=s,this.limit=r,this.limitType=o,this.startAt=a,this.endAt=u,this.wt=null,this.gt=null,this.startAt,this.endAt}}function Nf(t,e,n,i,s,r,o,a){return new Bt(t,e,n,i,s,r,o,a)}function kr(t){return new Bt(t)}function Qo(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function xr(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function Vi(t){for(const e of t.filters){const n=e.getFirstInequalityField();if(n!==null)return n}return null}function qu(t){return t.collectionGroup!==null}function St(t){const e=D(t);if(e.wt===null){e.wt=[];const n=Vi(e),i=xr(e);if(n!==null&&i===null)n.isKeyField()||e.wt.push(new It(n)),e.wt.push(new It(le.keyField(),"asc"));else{let s=!1;for(const r of e.explicitOrderBy)e.wt.push(r),r.field.isKeyField()&&(s=!0);if(!s){const r=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e.wt.push(new It(le.keyField(),r))}}}return e.wt}function Be(t){const e=D(t);if(!e.gt)if(e.limitType==="F")e.gt=zo(e.path,e.collectionGroup,St(e),e.filters,e.limit,e.startAt,e.endAt);else{const n=[];for(const r of St(e)){const o=r.dir==="desc"?"asc":"desc";n.push(new It(r.field,o))}const i=e.endAt?new hi(e.endAt.position,e.endAt.inclusive):null,s=e.startAt?new hi(e.startAt.position,e.startAt.inclusive):null;e.gt=zo(e.path,e.collectionGroup,n,e.filters,e.limit,i,s)}return e.gt}function xs(t,e){e.getFirstInequalityField(),Vi(t);const n=t.filters.concat([e]);return new Bt(t.path,t.collectionGroup,t.explicitOrderBy.slice(),n,t.limit,t.limitType,t.startAt,t.endAt)}function di(t,e,n){return new Bt(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Ui(t,e){return _r(Be(t),Be(e))&&t.limitType===e.limitType}function ju(t){return`${Nr(Be(t))}|lt:${t.limitType}`}function Ms(t){return`Query(target=${function(e){let n=e.path.canonicalString();return e.collectionGroup!==null&&(n+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(n+=`, filters: [${e.filters.map(i=>$u(i)).join(", ")}]`),Pi(e.limit)||(n+=", limit: "+e.limit),e.orderBy.length>0&&(n+=`, orderBy: [${e.orderBy.map(i=>function(s){return`${s.field.canonicalString()} (${s.dir})`}(i)).join(", ")}]`),e.startAt&&(n+=", startAt: ",n+=e.startAt.inclusive?"b:":"a:",n+=e.startAt.position.map(i=>kt(i)).join(",")),e.endAt&&(n+=", endAt: ",n+=e.endAt.inclusive?"a:":"b:",n+=e.endAt.position.map(i=>kt(i)).join(",")),`Target(${n})`}(Be(t))}; limitType=${t.limitType})`}function Bi(t,e){return e.isFoundDocument()&&function(n,i){const s=i.key.path;return n.collectionGroup!==null?i.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(s):E.isDocumentKey(n.path)?n.path.isEqual(s):n.path.isImmediateParentOf(s)}(t,e)&&function(n,i){for(const s of St(n))if(!s.field.isKeyField()&&i.data.field(s.field)===null)return!1;return!0}(t,e)&&function(n,i){for(const s of n.filters)if(!s.matches(i))return!1;return!0}(t,e)&&function(n,i){return!(n.startAt&&!function(s,r,o){const a=qo(s,r,o);return s.inclusive?a<=0:a<0}(n.startAt,St(n),i)||n.endAt&&!function(s,r,o){const a=qo(s,r,o);return s.inclusive?a>=0:a>0}(n.endAt,St(n),i))}(t,e)}function _f(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function Ku(t){return(e,n)=>{let i=!1;for(const s of St(t)){const r=kf(s,e,n);if(r!==0)return r;i=i||s.field.isKeyField()}return 0}}function kf(t,e,n){const i=t.field.isKeyField()?E.comparator(e.key,n.key):function(s,r,o){const a=r.data.field(s),u=o.data.field(s);return a!==null&&u!==null?_t(a,u):S()}(t.field,e,n);switch(t.dir){case"asc":return i;case"desc":return-1*i;default:return S()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(e){this.Pn=e}next(){return this.Pn+=2,this.Pn}static Vn(){return new xt(0)}static Sn(){return new xt(-1)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At{constructor(e){this.comparator=e?(n,i)=>e(n,i)||E.comparator(n.key,i.key):(n,i)=>E.comparator(n.key,i.key),this.keyedMap=jt(),this.sortedSet=new J(this.comparator)}static emptySet(e){return new At(e.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,i)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof At)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),i=e.sortedSet.getIterator();for(;n.hasNext();){const s=n.getNext().key,r=i.getNext().key;if(!s.isEqual(r))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
)`}copy(e,n){const i=new At;return i.comparator=this.comparator,i.keyedMap=e,i.sortedSet=n,i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ua{constructor(){this.Au=new J(E.comparator)}track(e){const n=e.doc.key,i=this.Au.get(n);i?e.type!==0&&i.type===3?this.Au=this.Au.insert(n,e):e.type===3&&i.type!==1?this.Au=this.Au.insert(n,{type:i.type,doc:e.doc}):e.type===2&&i.type===2?this.Au=this.Au.insert(n,{type:2,doc:e.doc}):e.type===2&&i.type===0?this.Au=this.Au.insert(n,{type:0,doc:e.doc}):e.type===1&&i.type===0?this.Au=this.Au.remove(n):e.type===1&&i.type===2?this.Au=this.Au.insert(n,{type:1,doc:i.doc}):e.type===0&&i.type===1?this.Au=this.Au.insert(n,{type:2,doc:e.doc}):S():this.Au=this.Au.insert(n,e)}Ru(){const e=[];return this.Au.inorderTraversal((n,i)=>{e.push(i)}),e}}class Mt{constructor(e,n,i,s,r,o,a,u,c){this.query=e,this.docs=n,this.oldDocs=i,this.docChanges=s,this.mutatedKeys=r,this.fromCache=o,this.syncStateChanged=a,this.excludesMetadataChanges=u,this.hasCachedResults=c}static fromInitialDocuments(e,n,i,s,r){const o=[];return n.forEach(a=>{o.push({type:0,doc:a})}),new Mt(e,n,At.emptySet(n),o,i,s,!0,!1,r)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Ui(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const n=this.docChanges,i=e.docChanges;if(n.length!==i.length)return!1;for(let s=0;s<n.length;s++)if(n[s].type!==i[s].type||!n[s].doc.isEqual(i[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Rt(fe.fromBase64String(e))}catch(n){throw new y(f.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Rt(fe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
